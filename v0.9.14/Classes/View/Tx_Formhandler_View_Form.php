...
class Tx_Formhandler_View_Form extends Tx_Formhandler_AbstractView {
	...
	protected function fillDefaultMarkers() {
		...
		$randomID = htmlspecialchars($this->gp['randomID']);
		...
		$markers['###HIDDEN_FIELDS###'] .= '
			<input type="hidden" id="removeFile-' . $randomID . '" name="' . $name . '" value="" />
		';
		...
		$markers['###HIDDEN_FIELDS###'] .= '
			<input type="hidden" id="removeFileField-' . $randomID . '" name="' . $name . '" value="" />
		';
		...
		$markers['###HIDDEN_FIELDS###'] .= '
			<input type="hidden" id="submitField-' . $randomID . '" name="' . $name . '" value="" />
		';
